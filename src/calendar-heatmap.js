...
function calendarHeatmap() {
  ...
  function chart() {
    ...
    var dateRange = d3.timeDays(start, end); // generates an array of date objects within the specified range
    var monthRange = d3.timeMonths(moment(start).startOf('month').toDate(), end); // it ignores the first month if the 1st date is after the start of the month
